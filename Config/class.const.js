...
export const FUTURE_CLASS_CREATION = 6; // class should be 24 hours in future
export const CLASS_CANCELATION_TIME = 6; // class should be cancel before 24 hours unless charge apply
export const CLASS_BOOKING_TIME = 6; // class should be Booked before 24 hours
